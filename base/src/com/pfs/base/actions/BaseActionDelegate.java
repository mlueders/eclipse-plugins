...
public abstract class BaseActionDelegate extends ActionDelegate implements IWorkbenchWindowActionDelegate, IViewActionDelegate {
  ...
  public void init( IViewPart view ) {
    _window = view.getSite().getWorkbenchWindow();
  }
