...
public abstract class ActivateEditorAction extends DevToolsAction {
	public static class Next extends ActivateEditorAction {
		protected int getIndexToActivate(int selectedIndex, int selectedVisibleIndex, int[] visibleIndices, int lastVisibleIndex,
				CTabItem[] items) throws Exception {
			int indexToActivate;
	...
	protected abstract int getIndexToActivate(int selectedIndex, int selectedVisibleIndex, int[] visibleIndeces, int lastVisibleIndex,
			CTabItem[] items) throws Exception;
